    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        <button type="button" class="btn btn-success btn-addon m-b-sm btn-rounded" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>Add New Student</button>
                    </div>
                    <div class="col-md-6">
                ...
                <!-- Modal -->
                <form id="add-row-form" action="{{ route('admin.student.store') }}" method="POST" autocomplete="off">
                    @csrf
                    {{ method_field('POST') }}
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="regNo" class="form-control" id="exampleInputEmail1" value="{{ old('regNo') }}">
                                    </div>
                                    <div class="form-group">
                        ...
                        <tbody>
                            @if (count($students) > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('editOrDelete')
                                            <a href="{{ route('admin.student.edit', $student->id) }}"><button class="btn btn-primary"><i class="fa fa-eye font-14"></i></button></a> |
                                            ...
                                            <a href="{{ route('admin.student.show', $student->id) }}"><button class="btn btn-warning">Course Registration</button></a> 
                                        @endcan
                                    </td>
                                </tr>
                                @endforeach
